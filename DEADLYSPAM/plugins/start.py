...
if config.ALIVE_PIC:
    ...
    DEADLY_IMG = "https://telegra.ph/file/d57877136da61e391eaec.jpg"

OWNER_INFO = config.OWNER_NAME
if config.OWNER_NAME:
    OWNER_NAME = OWNER_INFO
else:
    OWNER_NAME = "RUDRA SINGH"

OWNER_ID = config.OWNER_ID

Deadly_Button = [
        [
        Button.url("Cʜᴀɴɴᴇʟ", "https://t.me/supra_lll"),
        Button.url("Sᴜᴘᴘᴏʀᴛ", "https://t.me/supra_spam_bots")
        ],
        [
        Button.url("• Rᴇᴘᴏ •", "https://t.me/rudra-singh3588")
        ]
        ]
...
async def start(e):
    if e.chat_id is e.sender_id:
        ...
        myOwner = f"[RUDRA SINGH](tg://user?id={7043592671})"
        creator = f"[RUDRA SINGH](tg://user?id={6988882600})"
        DEADLY_ON = f"""
ʜᴇʏ {mention},
RUDRA SINGH:- {creator}!
RUDRA SINGH:- {myOwner}
